...
const QuotaCards = ({ t }: { t: (key: string) => string }) => (
  <div className="flex flex-col md:flex-row gap-3">
    <UserQuotaCard
      ...
      plusbuttontitle={t('addUser')}
      historybuttontitle={t('userRegistration')}
      className="admin-quota-card-bg-2 w-full"
      expiry="23 Juni 2024"
      amount={10}
    >
...
const DocumentInfoCards = ({ t }: { t: (key: string) => string }) => (
  <div className="grid md:grid-cols-3 grid-cols-2 mt-10 gap-4">
    ...
    />
    <DocInformationCard
      className="col-span-2 md:col-span-1 bg-[#FFF1BE]"
      title={t('UserWillExpired')}
      amount={12}
      Icon={WarningIcon}
      bgfill="#F8E08D"
      iconfill="#FFD53F"
