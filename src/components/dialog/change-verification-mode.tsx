...
import FRDialog from '@/components/dialog/face-recognition-verification';

const ChangeVerificationModeDialog = ({
  triggerClassName,
  iconFill = '#000'
}: {
    ...
    <AlertDialog>
      ...
      <AlertDialogTrigger asChild>
        <Button
          size="lg"
          className={cn(
            'mt-4 mb-4 w-full justify-start border-[#E0E0E0] hover:text-black bg-white font-semibold gap-2 border px-4 lg:hover:scale-105 transition-transform',
            triggerClassName
          )}
          variant="ghost"
        >
...
export default ChangeVerificationModeDialog;
