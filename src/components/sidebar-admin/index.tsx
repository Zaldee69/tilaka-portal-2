...
import SidebarAdminLinks from './sidebar-admin-links';
    ...
    >
      ...
      >
        <ScrollArea className={`h-[725px]`}>
          ...
          <div
            className={cn('flex justify-center gap-2 items-center flex-col')}
          >
            <div
          ...
          <div
            className={cn('px-5 mt-12 relative', {
              'px-2': !state.isOpen,
              'mt-10': !state.isOpen
            })}
          >
            ...
            <div
              className={cn('px-4', {
                'flex items-center px-0': !state.isOpen
              })}
            >
              <Link
                href="https://tilaka.id/ufaqs/"
                target="_blank"
                className="font-semibold flex gap-2 mt-6 items-center"
              >
                <QuestionAnswerIcon fill="#828282" />
                <div
                  className={cn('text-sm text-gray-1', {
                    hidden: !state.isOpen
                  })}
                >
                  FAQ
